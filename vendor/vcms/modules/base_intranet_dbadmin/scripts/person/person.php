...
if($libAuth->isLoggedin()){
	...
	if(in_array('internetwart', $libAuth->getOffices()) || in_array('datenpflegewart', $libAuth->getOffices())){
		...
		$fields = array_merge($fields, array('gruppe', 'password_hash'));
	}
	...
	*/
	...
	if($personRow['id'] != ''){
		...
		//image upload form
		echo '<form action="index.php?pid=intranet_admin_person&amp;id='. $personRow['id'] .'" method="post" enctype="multipart/form-data" class="form-horizontal text-center">';
