...
if($libAuth->isLoggedin()){
	...
	*/
	if($array['id'] != ''){
		echo '<p class="mb-4"><a href="index.php?pid=intranet_admin_vips&amp;aktion=delete&amp;id='.$array['id'].'" onclick="return confirm(\'Willst Du den Datensatz wirklich löschen?\')"><i class="fa fa-trash" aria-hidden="true"></i> Datensatz löschen</a></p>';
	}
	...
	*/
	...
	echo '<form action="index.php?pid=intranet_admin_vip' .$extraActionParam. '" method="post" class="">';
	echo '<fieldset>';
