...
if($libAuth->isLoggedin()){
	...
	*/
	if($array['id'] != ''){
		echo '<p class="mb-4"><form method="post" action="index.php?pid=intranet_admin_vips" style="display:inline" onsubmit="return confirm(\'Willst Du den Datensatz wirklich löschen?\')">';
