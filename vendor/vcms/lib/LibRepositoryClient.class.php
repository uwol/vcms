...
{
    public $repoHostname;
    public $modulesRelativeDirectoryPath = 'modules';
    public $engineUpdateScript = 'vendor/vcms/install/update.php';
    public $tempRelativeDirectoryPath = 'temp';
    public $tempAbsoluteDirectoryPath;
        ...
        if (is_dir($tempModuleAbsoluteDirectoryPath)) {
            if (is_file($tempModuleAbsoluteDirectoryPath. '/meta.json')) {
                if (!$isUpdate) {
                    ...
                    $filesToDelete = array_diff(scandir($moduleAbsoluteDirectoryPath), ['.', '..', 'custom']);
                    ...
                    $filesToCopy = array_diff(scandir($tempModuleAbsoluteDirectoryPath), ['.', '..']);
    ...
    public function refreshModuleHandler()
    {
