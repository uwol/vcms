...
class LibTable
{
    ...
    public function __construct(LibDb $libDb)
    {
        $this->libDb = $libDb;
    }
    ...
    public function addTableByStatement($stmt)
    {
        $rowindex = 0;
        $stmt->execute();
    ...
    public function addRowByArray($array)
    {
    ...
    public function writeContentAsHtmlTable($filename)
    {
        global $libString;
    ...
    public function writeContentAsCSV($filename)
    {
